...
#define PULLEY_REDUCTION_XY (10/34) // reduction
#define MM_BELT_PER_TURN_XY (5.08 * 10) // 10 tooth * 5.08 mm XL037
//
#define DEFAULT_X_STEPS_PER_MM (13.38582677165 * MICROSTEPS_XY)//((MOTOR_STP * MICROSTEPS_XY)/(PULLEY_REDUCTION_XY * MM_BELT_PER_TURN_XY))
#define DEFAULT_Y_STEPS_PER_MM (13.38582677165 * MICROSTEPS_XY)//((MOTOR_STP * MICROSTEPS_XY)/(PULLEY_REDUCTION_XY * MM_BELT_PER_TURN_XY))
#define DEFAULT_Z_STEPS_PER_MM ((MOTOR_STP * MICROSTEPS_Z)/(Z_SCREW_PITCH_MM))
#define DEFAULT_A_STEPS_PER_DEG (20.22222222222 * MICROSTEPS_Z) // (52/12)*(84/20) reduction
#define DEFAULT_X_MAX_RATE ((29500/DEFAULT_X_STEPS_PER_MM)*60) // mm/min
#define DEFAULT_Y_MAX_RATE ((29500/DEFAULT_Y_STEPS_PER_MM)*60) // mm/min
#define DEFAULT_Z_MAX_RATE ((29500/DEFAULT_Z_STEPS_PER_MM)*60) // mm/min
#define DEFAULT_A_MAX_RATE ((29500/DEFAULT_A_STEPS_PER_DEG)*60) // °/min
...
#define STEPPERS_DETECT_or_DISABLE_ALL_AXIS_DDR   DDRL
#define STEPPERS_DETECT_or_DISABLE_ALL_AXIS_PORT  PORTL
...
#define STEPPERS_DETECT_ALL_AXIS_PIN      PINL
...
#else
#define STEPPERS_DETECT_ALL_AXIS_PIN      0
