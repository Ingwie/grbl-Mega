  ...
  if (bit_istrue(settings.flags,BITFLAG_INVERT_ST_ENABLE))
    {
      ...
      if (!(STEPPERS_IS_PRESENT_ALL_AXIS_PIN & STEPPERS_IS_PRESENT_AXIS_X_MASK)) STEPPERS_DISABLE_ALL_AXIS_PORT |= STEPPERS_DISABLE_AXIS_X_MASK;
      if (!(STEPPERS_IS_PRESENT_ALL_AXIS_PIN & STEPPERS_IS_PRESENT_AXIS_Y_MASK)) STEPPERS_DISABLE_ALL_AXIS_PORT |= STEPPERS_DISABLE_AXIS_Y_MASK;
      if (!(STEPPERS_IS_PRESENT_ALL_AXIS_PIN & STEPPERS_IS_PRESENT_AXIS_Z_MASK)) STEPPERS_DISABLE_ALL_AXIS_PORT |= STEPPERS_DISABLE_AXIS_Z_MASK;
      if (!(STEPPERS_IS_PRESENT_ALL_AXIS_PIN & STEPPERS_IS_PRESENT_AXIS_A_MASK)) STEPPERS_DISABLE_ALL_AXIS_PORT |= STEPPERS_DISABLE_AXIS_A_MASK;
    }
  else
    {
      STEPPERS_DISABLE_PORT &= ~STEPPERS_DISABLE_MASK;
...
void st_go_idle()
{
  ...
  if (bit_istrue(settings.flags,BITFLAG_INVERT_ST_ENABLE)) { pin_state = !pin_state; } // Apply pin invert.
    ...
    {
      STEPPERS_DISABLE_PORT |= STEPPERS_DISABLE_MASK;
      STEPPERS_DISABLE_ALL_AXIS_PORT |= STEPPERS_DISABLE_AXIS_X_MASK;
      STEPPERS_DISABLE_ALL_AXIS_PORT |= STEPPERS_DISABLE_AXIS_Y_MASK;
      STEPPERS_DISABLE_ALL_AXIS_PORT |= STEPPERS_DISABLE_AXIS_Z_MASK;
      STEPPERS_DISABLE_ALL_AXIS_PORT |= STEPPERS_DISABLE_AXIS_A_MASK;
    }
  else
    {
      STEPPERS_DISABLE_PORT &= ~STEPPERS_DISABLE_MASK;
...
void stepper_init()
{
  ...
  // Configure enable/disable & presence pins
    ...
    STEPPERS_IS_PRESENT_ALL_AXIS_DDR &= ~STEPPERS_IS_PRESENT_ALL_AXIS_MASK; // axis presence input
    STEPPERS_IS_PRESENT_ALL_AXIS_PORT |= STEPPERS_IS_PRESENT_ALL_AXIS_MASK; // axis presence input internal pull-up resistors enabled
#endif
